...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 min-h-screen p-4 rounded-lg  border-2 border-[#D175B6] shadow-[0_0_10px_rgba(255,0,255,0.3)]">
      {/* Events Dropdown */}
      <div className="mb-4">
        <button
        ...
        {openEvents && (
          <ul className="mt-2 ml-4 text-sm space-y-2">
            <li className="bg-[#3a2c5c] px-3 py-1 rounded text-pink-300">
              New Requests
            </li>
